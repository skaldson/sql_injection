...
<?php
    ...
    function table_exist($dbh, $sql_str)
    {
        ...
        $is_exist = "SHOW TABLES LIKE {$victim_name}";
    ...
    function make_univarsal_table($result)
    {
    ...
    function you_victim($dbh, $sql_str)
    {
        $result = array();
        $sql_literals = explode(' ', $sql_str);
    ...
    function select_statement($dbh, $sql_str)
    {
        ...
        if($error_message){
            ...
            if($select_result){
                $result['select'] = (make_univarsal_table($select_result));
                return $result;
            }
            else{
    ...
    function output_statement($dbh, $sql_str)
    {
        ...
        if($error_message){
            ...
            if($show_result){
                $result['show'] = (make_univarsal_table($show_result));
            }
            else{
                $result['no_values'] = 'No values';
            }
    ...
    function connect_db()
    {
        ...
        $dsn = "$db_driver:host=$host; dbname=kolenapost";
